# Урок 2. Запуск кода и переменные
...
Прочитать главы 4 и 5 из книги.

Советы по изучению:

- Не обязательно запоминать все методы и функции. Вы их запомните по мере использования.
- Пытайтесь написать код из книги, не смотря. Так вы будете лучше запоминать синтаксис
- Выполняйте упражнения
- Если что-то не понятно, гуглите. Если и гугл не помог, пишите в чат.
